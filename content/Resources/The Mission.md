...
If you chose to write on this film, these instructions should help you craft yoru analysis of *The Mission* (1986). The film, which stars Robert De Niro and Jeremy Irons as Jesuit missionaries in the Paraguay/Brazil border area in the late 18th century, tells the story of nameless Indigenous people caught between the Bourbon reforms and missionaries, and the Jesuits under attack from the state. At a certain point, the Jesuits are faced with the choice of defending their missions or complying with royal dictates they detest. 

Your assignment is write (yourself, without the aid of AI) a critical review of *The Mission* that evaluates the merits of the film in relation to this semester. In order to do this, you will need to draw from assigned readings and lectures in class. You must use the two readings assigned from class. (No outside readings, though. Let’s keep it focused on the resources we’ve used in class.) Each paper should include a short overview of the plot, the important characters, and a discussion of the historical themes that they embody. Then, with reference to the readings, evaluate the historic merits of the film. Analyze the readings in the context of the film, and the film in the context of the readings.
